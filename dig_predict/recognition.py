...
def startExecution(response, new_session_dir, image_download_domain):
    ...
    if fetch_response.status_code == 200:
        ...
        initial_cropped_image_path = "/home/madhu/cropped_images/20240606194628_pdf_page_21.png"
...
response = {
        "s3_path": "testing/PART-C/20240606194628/pdf_page_21_1717882293680.png",
        "image_name": "20240606194628_pdf_page_21.png"
    }
...
def get_s3_path_from_database(image_name):
    try:
        ...
        image_name = '20240606193111_pdf_page_41.png'
